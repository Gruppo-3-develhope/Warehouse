...
public class Smartphone implements Prodotti {
    ...
    public Smartphone (String articolo, String produttore, String modello, double dimensioneDisplay, String spazioArchiviazione, double prezzoAquisto, double prezzoVendita) {
        this.id = generateID();
